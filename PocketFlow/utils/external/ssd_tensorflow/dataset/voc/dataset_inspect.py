...
# get the data structure of one example
...
if __name__ == '__main__':
    print('train:', count_example('/DATA/VOCdevkit/tfrecords', 'val-?????-of-?????'))
    print('val:', count_example('/DATA/VOCdevkit/tfrecords', 'val-?????-of-?????'))
    get_structure('/DATA/VOCdevkit/tfrecords', 'train-00007-of-00016')
    inspect_bbox('/DATA/VOCdevkit/tfrecords', 'train-?????-of-?????')
    inspect_bbox('/DATA/VOCdevkit/tfrecords', 'val-?????-of-?????')
